  ...
  },
  {
    ...
    simulatorBlurb: {
      ...
      bullets: [
        ...
        'На счёте 62.40 EXD',
        `В Upcoming: loyalty ${LOY_PERIOD_MATURE_LABEL} → ${LOY_ACTIVATION_MATURE_SHORT} и 3 EXD cashback (THB / JPY / INR)`,
      ],
    },
    availableRewardsExd: '0.00 EXD',
    tradingWalletLabel: 'Account #12345678',
    ...
    feedGroups: [G_APR20, G_APR19, G_APR18, G_APR1, G_MAR26, G_MAR25, G_MAR24],
  },
]
