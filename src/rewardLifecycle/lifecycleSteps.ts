...
export const LIFECYCLE_STEPS: LifecycleStep[] = [
  ...
  },
  {
    ...
    docRef: `§2 · ${LOY_PERIOD_OPEN_LABEL}, badge 3 · → ${upcomingLoyaltyDate(LOY_ACTIVATION_OPEN_SHORT)}`,
    simulatorTodayIso: LIFECYCLE_STEP_TODAY_ISO[1],
    simulatorBlurb: {
      lead: `Поторговал на этой неделе (${LOY_PERIOD_OPEN_LABEL}).`,
      bullets: [
        'Upcoming loyalty +3.20 EXD (3 ордера в пачке)',
  ...
  },
  {
    ...
    docRef: `§3 · ${LOY_ACTIVATION_OPEN_SHORT}: loyalty +3.20 EXD → Available`,
    simulatorTodayIso: LIFECYCLE_STEP_TODAY_ISO[2],
    simulatorBlurb: {
      lead: `Неделя ${LOY_PERIOD_OPEN_LABEL} закрылась, loyalty активировалась (${LOY_ACTIVATION_OPEN_SHORT}).`,
      bullets: [
        'Upcoming пустой (пачка ушла в Available)',
    ...
    activityPreview: [
      {
        ...
        date: `${LOY_ACTIVATION_OPEN_SHORT}, 23:58`,
        badge: '3',
  ...
  },
  {
    ...
    docRef: '§6 · 25 Jun · 3.20 EXD',
    simulatorTodayIso: LIFECYCLE_STEP_TODAY_ISO[3],
    simulatorBlurb: {
      lead: 'Перевёл EXD на торговый счёт (25 Jun).',
  ...
  },
  {
    ...
    docRef: '§7–8 · 26 Jun · spent 3.20 EXD',
    simulatorTodayIso: LIFECYCLE_STEP_TODAY_ISO[4],
    simulatorBlurb: {
      lead: 'Сделка со списанием EXD под cashback (26 Jun).',
      bullets: [
  ...
  },
  {
    ...
    docRef: '§8–9 · 28 Jun · +3 USD',
    simulatorTodayIso: LIFECYCLE_STEP_TODAY_ISO[5],
    simulatorBlurb: {
      lead: 'Cashback пришёл на счёт (28 Jun).',
      bullets: [
