/** Copy for EXD debited info sheet (Upcoming cashback order detail). */

export const EXD_DEBITED_LABEL = 'EXD debited'

export const EXD_DEBIT_SHEET_TITLE = 'EXD debited'

export const EXD_DEBIT_SHEET_LEAD =
